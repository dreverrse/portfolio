...
const translations = {
  id: {
    ...
    "guestbook.description":
      "Tinggalkan jejakmu di sini — sapa, kasih kesan, atau sekadar bilang halo. Semua pesan tersimpan di buku tamu ini.",
    "guestbook.namePlaceholder": "Nama kamu",
    "guestbook.messagePlaceholder": "Tinggalkan pesan atau kesan buat website ini…",
    "guestbook.send": "Kirim",
    "guestbook.sending": "Mengirim…",
    "guestbook.empty": "Belum ada pesan.",
    "guestbook.emptySub": "Jadilah orang pertama yang menulis.",
    "guestbook.errName": "Nama wajib diisi (maks 30 karakter).",
    "guestbook.errMessage": "Pesan wajib diisi (maks 500 karakter).",
    "guestbook.errSend": "Gagal mengirim pesan.",
    "blog.description":
  ...
  en: {
    ...
    "guestbook.description":
      "Leave your mark here — say hi, share your thoughts, or just drop a hello. All messages are saved in this guestbook.",
    "guestbook.namePlaceholder": "Your name",
    "guestbook.messagePlaceholder": "Leave a message for this website…",
    "guestbook.send": "Send",
    "guestbook.sending": "Sending…",
    "guestbook.empty": "No messages yet.",
    "guestbook.emptySub": "Be the first to write one.",
    "guestbook.errName": "Name is required (max 30 characters).",
    "guestbook.errMessage": "Message is required (max 500 characters).",
    "guestbook.errSend": "Failed to send message.",
    "blog.description":
